...
(setq backup-directory-alist `(("." . ,(concat lemacs/config-dir "/backups"))))
(setq delete-old-versions -1)

;; Make numeric backup versions unconditionally.
(setq version-control t)
(setq vc-make-backup-files t)
(setq auto-save-file-name-transforms `((".*" ,(expand-file-name (concat lemacs/config-dir "/auto-save-list/")) t)))
